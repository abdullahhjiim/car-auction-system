...
const Cars = () => {
  ...
  //     item = (
  //       <AccordionBody accordionId={obj.label}>
  //         <div className="search-multi-checkbox">
  //           <div className="mb-2 search-input">
  //             <input
  //               type="text"
  //               name=""
  ...
  //             />
  //           </div>
  //           <div className="serach-body">
  //             {obj.data.length > 0 &&
  //               (searchText && obj?.label === type ? searchData : obj.data).map(
  //                 (e, i) => {
  //                   return (
  //                     <Checkbox
  //                       onChange={(event) =>
  ...
  //           <div className="pb-2 pt-1 range-slider-wrapper">
  //             <InputRange
  //               formatLabel={() => ``}
  //               maxValue={max ?? 1}
  //               minValue={min ?? 0}
  //               value={price.value}
  //               onChange={_handleOdometer}
  //             />
  //           </div>
  ...
  //         valueMax={selectedYearMax}
  //         valueMin={selectedYearMin}
  //       />
  //     );
  ...
  //           <label>From:</label>
  //           <div className="react-date-picker-custom">
  //             <DatePicker
  //               selected={startDate}
  //               onChange={(date) => _onChangeDate(date, "start")}
  //               minDate={new Date()}
  ...
  //               selected={endDate}
  //               minDate={new Date()}
  //               onChange={(date) => _onChangeDate(date, "end")}
  //               dateFormat="yyyy/MM/dd"
  //               placeholderText="yyyy/MM/dd"
  //               className="form-control form-control-sm form-control-icon"
  //             />
  ...
  const _MakeAccordionItem = (obj) => {
    ...
    if (Array.isArray(obj.data) && obj.data.length > 0) {
      item = (
        <Accordion.Panel collapse={false} key={obj.label}>
          <hr className="my-1" />
