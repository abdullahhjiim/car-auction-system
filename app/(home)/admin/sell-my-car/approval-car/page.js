...
import CarApprovalTable from '@/components/admin/CarApprovalTable';
...
const ApprovalCar = () => {
  ...
  const fetchData = (urlStr) => {
    setLoading(true);
    const url = urlStr
      ? `/member-vehicles/selling-on-approval${urlStr}`
      : '/member-vehicles/selling-on-approval';
    authAxios
      .get(url, {
