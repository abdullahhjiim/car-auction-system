            ...
            <div className="w-full lg:w-2/3 xl:w-3/4">
              <BreadCrumbs
                breadCumbsArr={[
                  ...
                  { link: '/admin/sell-my-car/sold-car', text: 'Sold Cars' },
                  { link: '', text: 'Detail' },
                ]}
              />
              ...
              {vehicle?.auction && (
                <div className="shadow-2xl p-2 rounded-md mt-6 border border-gray-300">
                  <h1 className="text-2xl text-primary m-2 font-semibold">
                    Auction Info
                  </h1>
                  <div className="p-2">
                                ...
                                <table className="min-w-full text-left text-sm font-light">
                                  <tbody>
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      ...
                                      <td className="whitespace-nowrap px-6 py-4">
                                        {vehicle?.auction?.auction_type_name}
                                      </td>
                                    </tr>
                                    <tr className="border-b dark:border-neutral-500">
                                      <td className="whitespace-nowrap px-6 py-4 font-medium">
                                      ...
                                      <td className="whitespace-nowrap px-6 py-4">
                                        {vehicle?.auction?.auction_yard_name}
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                ...
                                <table className="min-w-full text-left text-sm font-light">
                                  <tbody>
                                    ...
                                    <tr className="border-b dark:border-neutral-500">
                                      ...
                                      <td className="whitespace-nowrap px-6 py-4">
                                        {vehicle?.auction?.total_vehicles}
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
