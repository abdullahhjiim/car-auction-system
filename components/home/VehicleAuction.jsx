...
const VehicleAuction = () => {
  ...
  useEffect(() => {
    setLoading(true);
    authAxios
      .get("/lot/in-auction-vehicles?is_random_order=true&limit=6")
      .then((res) => {
        ...
        <div className="text-center">
          <div className="relative">
            <motion.div
              ...
              className="absolute -top-[50%] md:-top-[130%] left-[35%]"
            >
          ...
          >
            Currently listed Auction Vehicle
          </motion.h4>
          <motion.div
            initial={{ x: 100 }}
            whileInView={{ x: 0, transition: { duration: 1 } }}
          ...
          {loading ? (
            ...
            <>
              {data?.length === 0 ? (
                ...
                <>
                  {data?.map((item, i) => {
                    const { lot_number, vehicle_images, title } = item;
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative bottom-12 px-3 z-10">
                          <Link href={`/all-vehicle/${lot_number}`}>
                            <h4
                              className="text-white font-secondary cursor-pointer text-xl font-bold capitalize  truncate"
                              title={title}
                            >
                              {title}
                            </h4>
