...
const VehicleTable = ({
  ...
  const handleView = (vehicleID) => {
    router.push(`/admin/sell-through-gulf/${vehicleID}`);
  };
  ...
  return (
    <div>
      <div className="flex justify-between">
        ...
        <div>
          <button
            ...
            className="bg-primary p-1 rounded-md text-white hover:opacity-70 duration-200"
          >
            {" "}
            + New Vehicle
          </button>
            ...
            <tbody>
              ...
              {tableBodyData.map((item, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">{item?.status_name}</td>
                  <td className="px-6 py-4 text-center">
      ...
      {/* <CommonToast setToastObj={setToastObj} toastObj={toastObj} /> */}
      <ToastContainer />
    </div>
  );
};
