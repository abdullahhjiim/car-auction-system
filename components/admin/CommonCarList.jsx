  ...
  const deleteConfirm = (vehicleID) => {
    authAxios
      ...
      .then((res) => {
        ...
        toast(res?.data?.message ?? "Successfully Delete Data", {
          position: "top-right",
          autoClose: 3000,
  ...
  return (
    <div>
      <div className="flex justify-between">
        ...
        <div>
          {name == "All Cars" && user?.approve_for_bidding == 1 && (
            <button
            ...
            <tbody>
              ...
              {tableBodyData.map((item, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-left">{item?.vin}</td>
                  <td className="px-6 py-4 text-left">{item?.title}</td>

                  <td className="px-6 py-4 text-left">{item?.status_name}</td>
                  <td className="px-6 py-4 text-left">{item?.runs}</td>
                  <td className="px-6 py-4 text-left">
